...
## [v0.0.0](https://github.com/sacloud/go-template/compare/v0.0.8...v0.0.0) - 2026-07-15
...
- ghcr.io/sacloud/textlint-action v0.1.0 by @yamamoto-febc in https://github.com/sacloud/go-template/pull/40
- Update github settings by @repeatedly in https://github.com/sacloud/go-template/pull/41
- ci: bump Songmu/tagpr from 1.8.4 to 1.9.0 by @dependabot[bot] in https://github.com/sacloud/go-template/pull/42
- Toolchain version up by @shyouhei in https://github.com/sacloud/go-template/pull/48
- ci: bump actions/setup-go from 5.5.0 to 6.2.0 by @dependabot[bot] in https://github.com/sacloud/go-template/pull/47
- ci: bump docker/setup-buildx-action from 3.11.1 to 3.12.0 by @dependabot[bot] in https://github.com/sacloud/go-template/pull/46
- ci: bump docker/build-push-action from 5.4.0 to 6.18.0 by @dependabot[bot] in https://github.com/sacloud/go-template/pull/43
- more files to ignore for textlint by @shyouhei in https://github.com/sacloud/go-template/pull/49
- ci: bump docker/metadata-action from 5.8.0 to 5.10.0 by @dependabot[bot] in https://github.com/sacloud/go-template/pull/50
- ci: bump docker/setup-qemu-action from 3.6.0 to 3.7.0 by @dependabot[bot] in https://github.com/sacloud/go-template/pull/51
- ci: bump actions/checkout from 5.0.0 to 6.0.2 by @dependabot[bot] in https://github.com/sacloud/go-template/pull/52
- ci: bump docker/login-action from 3.5.0 to 3.7.0 by @dependabot[bot] in https://github.com/sacloud/go-template/pull/53
- tagpr: use custom major/minorLabels by @yamamoto-febc in https://github.com/sacloud/go-template/pull/55
- go @ 1.26.1 by @shyouhei in https://github.com/sacloud/go-template/pull/62
- ghcr.io now accepts GITHUB_TOKEN by @shyouhei in https://github.com/sacloud/go-template/pull/63
